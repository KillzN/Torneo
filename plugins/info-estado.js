...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[1]} STREAMSHOP
  ${tradutor.texto1[2]} +584120320626
  ...
  const Message = {
    document: { url: `https://www.instagram.com/torneos.esport.ff/` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://www.instagram.com/torneos.esport.ff/",
        mediaType: 2,
        previewType: "pdf",
        title: "STREAMSHOP",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://www.instagram.com/torneos.esport.ff/",
      },
    },
    caption: info,
    footer: wm,
